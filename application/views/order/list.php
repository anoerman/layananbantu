							...
							<table class="table table-striped table-hover table-bordered">
								...
								<?php foreach ($data_order_baru->result() as $data_1): ?>
									<tr>
										<td>
											<div class="col-md-4 col-sm-12">
												<div class="row">
													...
													<div class="col-md-12 col-sm-12">
														<span class="glyphicon glyphicon-comment"></span> &nbsp; <?php echo $data_1->nama_status; ?>
													</div>
												</div>
											</div>
										...
										<td>
											<a href="<?php echo base_url('order/detail/'.$data_1->kode); ?>" class="btn btn-sm btn-primary">Detail</a>
										</td>
									</tr>
								<?php endforeach; ?>
								</tbody>
										...
										<td>
											<div class="col-md-4 col-sm-12">
												<div class="row">
													...
													<div class="col-md-12 col-sm-12">
														<span class="glyphicon glyphicon-comment"></span> &nbsp; <?php echo $data_3->nama_status; ?>
													</div>
												</div>
											</div>
											<div class="col-md-8 col-sm-12">
										...
										<td>
											<div class="col-md-4 col-sm-12">
												<div class="row">
													...
													<div class="col-md-12 col-sm-12">
														<span class="glyphicon glyphicon-comment"></span> &nbsp; <?php echo $data_4->nama_status; ?>
													</div>
												</div>
											</div>
											<div class="col-md-8 col-sm-12">
										...
										<td>
											<div class="col-md-4 col-sm-12">
												<div class="row">
													...
													<div class="col-md-12 col-sm-12">
														<span class="glyphicon glyphicon-comment"></span> &nbsp; <?php echo $data_5->nama_status; ?>
													</div>
												</div>
											</div>
											<div class="col-md-8 col-sm-12">
