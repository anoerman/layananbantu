									...
									<div class="form-group">
										...
										<div class="col-md-8 col-sm-12">
											<div class="input-group input-daterange">
												<input type="text" name="tanggal_awal" id="tanggal_awal" class="form-control" placeholder="Tanggal Awal" value="<?php echo $tanggal_awal ?>" required>
												<div class="input-group-addon">s/d</div>
												<input type="text" name="tanggal_akhir" id="tanggal_akhir" class="form-control" placeholder="Tanggal Akhir" value="<?php echo $tanggal_akhir ?>" required>
