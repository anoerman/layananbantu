...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<a href="<?php echo base_url(); ?>" class="logo">
			...
			if (strpos($this->config->item('site_name'), " ") !== false) {
				$ex_site_name = explode(" ", $this->config->item('site_name'));
				for ($i=0; $i < count($ex_site_name); $i++) {
					echo strtoupper(substr($ex_site_name[$i], 0, 1));
				}
			}
			else {
				echo strtoupper(substr($this->config->item('site_name'), 0, 1));
			}
			?></span>
