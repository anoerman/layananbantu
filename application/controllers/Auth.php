...
class Auth extends CI_Controller
{
	...
	*/
	public function index()
	{
		...
		else
		{
			...
			$this->data['cabang_model']   = $this->cabang_model;
			$this->data['regional_model'] = $this->regional_model;
	...
	*/
	public function create_user()
	{
		...
		$this->form_validation->set_rules('cabang_id', 'Cabang', 'trim|required');
	...
	*/
	public function edit_user($id)
	{
		...
		// Set cabang datas
		$this->data['cabang_list']    = $this->cabang_model->get_cabang("", "1");
		$this->data['current_cabang'] = $user->cabang_id;

		// Set regional datas
		$this->data['regional_list']    = $this->regional_model->get_regional_by_cabang($user->cabang_id);
		$this->data['current_regional'] = $user->regional_id;
